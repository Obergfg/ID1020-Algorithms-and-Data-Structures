 ...
 *
 *  The code sorts the elements of a given array in either ascending of descending order using the algorithm "Insert Sort", and counts
 *  the number of times an exchange or "swap" is being made.
...
public class Assignment3 {
     ...
     *
     * @param elements are the elements being sorted.
     */
    private static void insertSort(int[] elements, boolean descending) {
